...
goog.addDependency("../client/decision_support.js", ['client.decision_support'], ['cljs.core', 'clojure.set']);
...
goog.addDependency("../client/brewers_main.js", ['client.brewers_main'], ['ajax.core', 'om_bootstrap.modal', 'om_tools.dom', 'om_bootstrap.grid', 'cljs.core', 'om_bootstrap.panel', 'om.dom', 'client.decision_support', 'om_bootstrap.nav', 'om.core', 'om_bootstrap.progress_bar', 'om_bootstrap.button', 'cljs.reader', 'om_bootstrap.table', 'om_bootstrap.random', 'om_bootstrap.input', 'garden.core']);
