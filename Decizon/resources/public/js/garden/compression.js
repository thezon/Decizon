 ...
 */
garden.compression.token_fn = (function garden$compression$token_fn(p__32904){
var vec__32906 = p__32904;
var tag = cljs.core.nth.call(null,vec__32906,(0),null);
var re = cljs.core.nth.call(null,vec__32906,(1),null);
return ((function (vec__32906,tag,re){
return (function (s){
...
return garden.compression.tokenizer.cljs$core$IFn$_invoke$arity$variadic(argseq__12388__auto__);
});
...
return p1__32907_SHARP_.call(null,s);
});})(fs))
,fs);
});
;})(fs))
...
garden.compression.tokenizer.cljs$lang$applyTo = (function (seq32908){
return garden.compression.tokenizer.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq32908));
});
/**
...
var map__32911 = temp__4423__auto__;
var map__32911__$1 = ((cljs.core.seq_QMARK_.call(null,map__32911))?cljs.core.apply.call(null,cljs.core.hash_map,map__32911):map__32911);
var tag = cljs.core.get.call(null,map__32911__$1,new cljs.core.Keyword(null,"tag","tag",-1290361223));
var chunk = cljs.core.get.call(null,map__32911__$1,new cljs.core.Keyword(null,"chunk","chunk",-1191159620));
var size = cljs.core.get.call(null,map__32911__$1,new cljs.core.Keyword(null,"size","size",1098693007));
var G__32913 = cljs.core.subs.call(null,s1,size);
var G__32914 = [cljs.core.str(s2),cljs.core.str((function (){var G__32912 = (((tag instanceof cljs.core.Keyword))?tag.fqn:null);
switch (G__32912) {
case "l-brace":
return "}";
