...
return cljs.core.assoc.call(null,frame,new cljs.core.Keyword(null,"eids","eids",1546550700),eids,new cljs.core.Keyword(null,"specs","specs",1426570741),cljs.core.seq.call(null,new cljs.core.Keyword(null,"attrs","attrs",-2090668713).cljs$core$IFn$_invoke$arity$1(pattern)),new cljs.core.Keyword(null,"wildcard?","wildcard?",-686044101),new cljs.core.Keyword(null,"wildcard?","wildcard?",-686044101).cljs$core$IFn$_invoke$arity$1(pattern),new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.transient$.call(null,cljs.core.PersistentArrayMap.EMPTY),new cljs.core.Keyword(null,"results","results",-1134170113),(function (){var G__34053 = new cljs.core.Keyword(null,"results","results",-1134170113).cljs$core$IFn$_invoke$arity$1(frame);
var G__34053__$1 = ((cljs.core.seq.call(null,kvps))?cljs.core.conj_BANG_.call(null,G__34053,kvps):G__34053);
return G__34053__$1;
})());
});
datascript.pull_api.push_recursion = (function datascript$pull_api$push_recursion(rec,attr,eid){
var map__34055 = rec;
var map__34055__$1 = ((cljs.core.seq_QMARK_.call(null,map__34055))?cljs.core.apply.call(null,cljs.core.hash_map,map__34055):map__34055);
var depth = cljs.core.get.call(null,map__34055__$1,new cljs.core.Keyword(null,"depth","depth",1768663640));
var seen = cljs.core.get.call(null,map__34055__$1,new cljs.core.Keyword(null,"seen","seen",-518999789));
...
var G__34057 = new cljs.core.Keyword(null,"kvps","kvps",65308317).cljs$core$IFn$_invoke$arity$1(frame);
var G__34057__$1 = (((G__34057 == null))?null:cljs.core.persistent_BANG_.call(null,G__34057));
var G__34057__$2 = (((G__34057__$1 == null))?null:cljs.core.get.call(null,G__34057__$1,key));
return G__34057__$2;
});
...
datascript.pull_api.pull_recursion_frame = (function datascript$pull_api$pull_recursion_frame(db,p__34058){
var vec__34061 = p__34058;
var frame = cljs.core.nth.call(null,vec__34061,(0),null);
var frames = cljs.core.nthnext.call(null,vec__34061,(1));
...
var or__11348__auto__ = datascript.pull_api.pull_seen_eid.call(null,frame__$1,frames,eid);
...
var results = (function (){var G__34062 = new cljs.core.Keyword(null,"results","results",-1134170113).cljs$core$IFn$_invoke$arity$1(frame);
var G__34062__$1 = ((cljs.core.seq.call(null,kvps))?cljs.core.conj_BANG_.call(null,G__34062,kvps):G__34062);
return G__34062__$1;
})();
...
var map__34064 = parent;
var map__34064__$1 = ((cljs.core.seq_QMARK_.call(null,map__34064))?cljs.core.apply.call(null,cljs.core.hash_map,map__34064):map__34064);
var recursion = cljs.core.get.call(null,map__34064__$1,new cljs.core.Keyword(null,"recursion","recursion",-749738765));
var pattern = cljs.core.get.call(null,map__34064__$1,new cljs.core.Keyword(null,"pattern","pattern",242135423));
...
var pattern_34065 = (new datascript.pull_parser.PullSpec(true,cljs.core.PersistentArrayMap.EMPTY,null,null,null));
datascript.pull_api.expand_frame = ((function (pattern_34065){
...
return cljs.core.assoc.call(null,datascript.pull_api.subpattern_frame.call(null,pattern_34065,eids,multi_QMARK_,attr_key),new cljs.core.Keyword(null,"recursion","recursion",-749738765),rec);
});})(pattern_34065))
;
datascript.pull_api.pull_attr_datoms = (function datascript$pull_api$pull_attr_datoms(db,attr_key,attr,eid,forward_QMARK_,datoms,opts,p__34067){
var vec__34073 = p__34067;
var parent = cljs.core.nth.call(null,vec__34073,(0),null);
var frames = cljs.core.nthnext.call(null,vec__34073,(1));
...
var found = cljs.core.not_empty.call(null,(function (){var G__34074 = datoms;
var G__34074__$1 = (cljs.core.truth_(limit)?cljs.core.into.call(null,cljs.core.PersistentVector.EMPTY,cljs.core.take.call(null,limit),G__34074):G__34074);
return G__34074__$1;
})());
...
var multi_QMARK_ = (cljs.core.truth_(forward_QMARK_)?datascript.core.multival_QMARK_.call(null,db,attr):!(component_QMARK_));
var datom_val = (cljs.core.truth_(forward_QMARK_)?((function (ref_QMARK_,component_QMARK_,multi_QMARK_,limit,found,vec__34073,parent,frames){
return (function (d){
return d.v;
});})(ref_QMARK_,component_QMARK_,multi_QMARK_,limit,found,vec__34073,parent,frames))
:((function (ref_QMARK_,component_QMARK_,multi_QMARK_,limit,found,vec__34073,parent,frames){
return (function (d){
return d.e;
});})(ref_QMARK_,component_QMARK_,multi_QMARK_,limit,found,vec__34073,parent,frames))
);
...
if(cljs.core.truth_((function (){var and__11336__auto__ = component_QMARK_;
...
var as_value = (function (){var G__34075 = datom_val;
var G__34075__$1 = ((ref_QMARK_)?cljs.core.comp.call(null,((function (G__34075,ref_QMARK_,component_QMARK_,multi_QMARK_,datom_val,limit,found,vec__34073,parent,frames){
return (function (p1__34066_SHARP_){
return cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword("db","id","db/id",-1388397098)],[p1__34066_SHARP_]);
});})(G__34075,ref_QMARK_,component_QMARK_,multi_QMARK_,datom_val,limit,found,vec__34073,parent,frames))
,G__34075):G__34075);
return G__34075__$1;
})();
var single_QMARK_ = !(multi_QMARK_);
return cljs.core.conj.call(null,frames,cljs.core.update.call(null,parent,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,attr_key,(function (){var G__34076 = cljs.core.into.call(null,cljs.core.PersistentVector.EMPTY,cljs.core.map.call(null,as_value),found);
var G__34076__$1 = ((single_QMARK_)?cljs.core.first.call(null,G__34076):G__34076);
return G__34076__$1;
})()));
...
return cljs.core.conj.call(null,frames,(function (){var G__34077 = parent;
var G__34077__$1 = ((cljs.core.contains_QMARK_.call(null,opts,new cljs.core.Keyword(null,"default","default",-1987822328)))?cljs.core.update.call(null,G__34077,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,attr_key,new cljs.core.Keyword(null,"default","default",-1987822328).cljs$core$IFn$_invoke$arity$1(opts)):G__34077);
return G__34077__$1;
})());
}
});
...
var vec__34079 = spec;
var attr_key = cljs.core.nth.call(null,vec__34079,(0),null);
var opts = cljs.core.nth.call(null,vec__34079,(1),null);
...
datascript.pull_api.filter_reverse_attrs = cljs.core.filter.call(null,(function (p__34080){
...
datascript.pull_api.pull_expand_reverse_frame = (function datascript$pull_api$pull_expand_reverse_frame(db,p__34082){
var vec__34084 = p__34082;
var frame = cljs.core.nth.call(null,vec__34084,(0),null);
var frames = cljs.core.nthnext.call(null,vec__34084,(1));
return datascript.pull_api.expand_result.call(null,frames,datascript.pull_api.into_BANG_.call(null,new cljs.core.Keyword(null,"expand-kvps","expand-kvps",44141154).cljs$core$IFn$_invoke$arity$1(frame),(function (){var or__11348__auto__ = datascript.pull_api.single_frame_result.call(null,new cljs.core.Keyword("datascript.pull-api","expand-rev","datascript.pull-api/expand-rev",2143627459),frame);
if(cljs.core.truth_(or__11348__auto__)){
return or__11348__auto__;
} else {
...
datascript.pull_api.pull_expand_frame = (function datascript$pull_api$pull_expand_frame(db,p__34085){
var vec__34088 = p__34085;
var frame = cljs.core.nth.call(null,vec__34088,(0),null);
var frames = cljs.core.nthnext.call(null,vec__34088,(1));
...
var vec__34089 = cljs.core.first.call(null,datoms_by_attr);
var attr = cljs.core.nth.call(null,vec__34089,(0),null);
var datoms = cljs.core.nth.call(null,vec__34089,(1),null);
...
var map__34092 = frame;
var map__34092__$1 = ((cljs.core.seq_QMARK_.call(null,map__34092))?cljs.core.apply.call(null,cljs.core.hash_map,map__34092):map__34092);
var attr = cljs.core.get.call(null,map__34092__$1,new cljs.core.Keyword(null,"attr","attr",-604132353));
var recursion = cljs.core.get.call(null,map__34092__$1,new cljs.core.Keyword(null,"recursion","recursion",-749738765));
var rec = (function (){var G__34093 = recursion;
var G__34093__$1 = ((cljs.core.some_QMARK_.call(null,attr))?datascript.pull_api.push_recursion.call(null,G__34093,attr,eid):G__34093);
return G__34093__$1;
})();
...
var map__34095 = frame;
var map__34095__$1 = ((cljs.core.seq_QMARK_.call(null,map__34095))?cljs.core.apply.call(null,cljs.core.hash_map,map__34095):map__34095);
var eid = cljs.core.get.call(null,map__34095__$1,new cljs.core.Keyword(null,"eid","eid",559519930));
var pattern = cljs.core.get.call(null,map__34095__$1,new cljs.core.Keyword(null,"pattern","pattern",242135423));
var or__11348__auto__ = datascript.pull_api.pull_seen_eid.call(null,frame,frames,eid);
if(cljs.core.truth_(or__11348__auto__)){
return or__11348__auto__;
} else {
...
datascript.pull_api.pull_pattern_frame = (function datascript$pull_api$pull_pattern_frame(db,p__34096){
while(true){
var vec__34098 = p__34096;
var frame = cljs.core.nth.call(null,vec__34098,(0),null);
var frames = cljs.core.nthnext.call(null,vec__34098,(1));
var temp__4423__auto__ = cljs.core.seq.call(null,new cljs.core.Keyword(null,"eids","eids",1546550700).cljs$core$IFn$_invoke$arity$1(frame));
if(temp__4423__auto__){
var eids = temp__4423__auto__;
...
var G__34099 = db;
var G__34100 = cljs.core.conj.call(null,frames,datascript.pull_api.reset_frame.call(null,frame,cljs.core.rest.call(null,eids),cljs.core.not_empty.call(null,cljs.core.persistent_BANG_.call(null,new cljs.core.Keyword(null,"kvps","kvps",65308317).cljs$core$IFn$_invoke$arity$1(frame)))));
db = G__34099;
p__34096 = G__34100;
continue;
}
...
while(true){
var G__34105 = (((new cljs.core.Keyword(null,"state","state",-1988618099).cljs$core$IFn$_invoke$arity$1(cljs.core.first.call(null,frames)) instanceof cljs.core.Keyword))?new cljs.core.Keyword(null,"state","state",-1988618099).cljs$core$IFn$_invoke$arity$1(cljs.core.first.call(null,frames)).fqn:null);
switch (G__34105) {
case "expand":
var G__34110 = db;
var G__34111 = datascript.pull_api.pull_expand_frame.call(null,db,frames);
db = G__34110;
frames = G__34111;
continue;
...
case "expand-rev":
var G__34112 = db;
var G__34113 = datascript.pull_api.pull_expand_reverse_frame.call(null,db,frames);
db = G__34112;
frames = G__34113;
continue;
...
case "pattern":
var G__34114 = db;
var G__34115 = datascript.pull_api.pull_pattern_frame.call(null,db,frames);
db = G__34114;
frames = G__34115;
continue;
...
case "recursion":
var G__34116 = db;
var G__34117 = datascript.pull_api.pull_recursion_frame.call(null,db,frames);
db = G__34116;
frames = G__34117;
continue;
...
break;
case "done":
var vec__34106 = frames;
var f = cljs.core.nth.call(null,vec__34106,(0),null);
var remaining = cljs.core.nthnext.call(null,vec__34106,(1));
var result = (function (){var G__34107 = cljs.core.persistent_BANG_.call(null,new cljs.core.Keyword(null,"results","results",-1134170113).cljs$core$IFn$_invoke$arity$1(f));
var G__34107__$1 = ((cljs.core.not.call(null,new cljs.core.Keyword(null,"multi?","multi?",-749311069).cljs$core$IFn$_invoke$arity$1(f)))?cljs.core.first.call(null,G__34107):G__34107);
return G__34107__$1;
})();
if(cljs.core.seq.call(null,remaining)){
var G__34118 = db;
var G__34119 = cljs.core.conj.call(null,cljs.core.rest.call(null,remaining),(function (){var G__34108 = cljs.core.first.call(null,remaining);
var G__34108__$1 = (cljs.core.truth_(result)?cljs.core.update.call(null,G__34108,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,new cljs.core.Keyword(null,"attr","attr",-604132353).cljs$core$IFn$_invoke$arity$1(f),result):G__34108);
return G__34108__$1;
})());
db = G__34118;
frames = G__34119;
...
var eids__$1 = cljs.core.into.call(null,cljs.core.PersistentVector.EMPTY,cljs.core.map.call(null,(function (p1__34120_SHARP_){
return datascript.core.entid_strict.call(null,db,p1__34120_SHARP_);
})),eids);
